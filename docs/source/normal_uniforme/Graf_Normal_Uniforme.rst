Grafica Distribución Normal o Uniforme para motivar el Intervalo de Confianza
=============================================================================
...
.. code:: R
  ...
  fun1 <- function(pob=0, del1=0, h1=0, h2=0, titulo='', sujetos='', fre=TRUE){
     ...
     por = ss1*100/nl
     cat('porcentaje de ', sujetos, ' de la población de la media a una desviación estándar= ', por, '\n\n\n')
...
**Toma muestras de una Población y calculas sus medias**
...
**convierte medidas a medidas estandarizadas**
...
sujetos = ' sujetos estandarizados '
del1 = .1
fre = TRUE
...
sujetos = ' sujetos estandarizados normalizados'
del1 = .1 
h1 = 0
h2 = 0
fre = FALSE
...
**===================================================**
**EXPERIMENTO 2. distribucion normal**
...
.. code:: R
   ...
   pob <- round(rnorm(100, mean=50, sd=15))

   if (opt == "1"){
     tit <- "Distribución de la Población Normal"
     h1 = 5
     h2 = 2
     del1 = 1
     sujetos = ' sujetos '
